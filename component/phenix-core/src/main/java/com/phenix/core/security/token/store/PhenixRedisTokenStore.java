package com.phenix.core.security.token.store;
...
@Component
public class PhenixRedisTokenStore implements TokenStore {
    ...
    public PhenixRedisTokenStore(RedisConnectionFactory connectionFactory) {
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        ...
        try {
            ...
            if (token.getExpiration() != null) {
                Integer seconds = 43200;
                Date expirationDate = this.addSeconds(new Date(), seconds);
                defaultOAuth2AccessToken.setExpiration(expirationDate);
