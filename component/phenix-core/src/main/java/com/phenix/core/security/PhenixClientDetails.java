...
public class PhenixClientDetails implements ClientDetails , Serializable {
    ...
    public PhenixClientDetails() {
    }

    public PhenixClientDetails(ClientDetails prototype) {
        this();
    ...
    public PhenixClientDetails(String clientId, String resourceIds,
    ...
    public void setAuthoritiesExt(
            Collection<PhenixAuthority> authorities) {
        this.authorities = new ArrayList<GrantedAuthority>(authorities);
    }
    ...
    public boolean equals(Object obj) {
        ...
        PhenixClientDetails other = (PhenixClientDetails) obj;
    ...
    public String toString() {
        return "PhenixClientDetails [clientId=" + clientId + ", clientSecret="
